...
uint16_t w25qxx_GetID(void)
{
	...
	if(w25qxx_Mode == w25qxx_SPIMode)
		QSPI_Send_CMD(&hqspi,W25X_JedecDeviceID,0x00,QSPI_ADDRESS_NONE,0,QSPI_INSTRUCTION_1_LINE,QSPI_ADDRESS_NONE, QSPI_DATA_1_LINE, 3);
	else
		QSPI_Send_CMD(&hqspi,W25X_JedecDeviceID,0x00,QSPI_ADDRESS_NONE,0,QSPI_INSTRUCTION_4_LINES,QSPI_ADDRESS_NONE, QSPI_DATA_4_LINES, 3);
