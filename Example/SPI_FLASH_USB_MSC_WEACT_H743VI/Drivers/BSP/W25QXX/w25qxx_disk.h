 ...
 * @file    w25qxx_disk.h
 * @author  ChatGPT
 * @brief   W25Qxx Block Device Driver
 *
...
#ifndef __W25QXX_DISK_H
#define __W25QXX_DISK_H
...
#define W25QXX_DISK_SECTOR_SIZE          512U

/* W25Q erase block size */

#define W25QXX_DISK_ERASE_SIZE           4096U

/* Number of logical sectors inside one erase block */

#define W25QXX_DISK_SECTORS_PER_ERASE    \
    (W25QXX_DISK_ERASE_SIZE / W25QXX_DISK_SECTOR_SIZE)
 ...
 *      Number of sectors
 */
W25QXX_DiskStatus W25QXX_Disk_ReadSectors(
        uint32_t sector,
        uint8_t *buffer,
        uint32_t count);
 ...
 *
 */
W25QXX_DiskStatus W25QXX_Disk_WriteSectors(
        uint32_t sector,
 ...
 *      Erase block number
 */
W25QXX_DiskStatus W25QXX_Disk_EraseBlock(
 ...
 */
uint32_t W25QXX_Disk_SectorToAddress(
        uint32_t sector);

/**
 * @brief Convert Flash Address -> Logical Sector
 */
uint32_t W25QXX_Disk_AddressToSector(
        uint32_t address);
